                ...
                <div className="relative flex h-24 items-center justify-between">
                    ...
                    <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                        <div className="flex flex-shrink-0 items-center">
                            <span className='text-5xl font-bold font-serif text-stone-50'>bliss</span>
                        </div>

                        <div className="hidden sm:ml-20 sm:block">
                            <div className="flex space-x-4 font-serif text-lg text-stone-100 underline-offset-4">
                    ...
                    <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                        ...
                        <div className="relative ml-3">
                            <div>
                                <button type="button" className="relative flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                                    ...
                                    <img className="h-8 w-8 rounded-full" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="alternative " />
                                </button>
                            </div>
                        </div>
                        ...
                        {
                            data?.user ?
                                <button onClick={() => signOut()} className='text-white pl-2 cursor-pointer'>Sign Out</button>
                                :
                                <button onClick={() => signIn()} className='text-white pl-2 cursor-pointer'>Sign In</button>
                        }
                    </div>
                </div>
            </div>
            {
                open ?
                    <div className="sm:hidden" id="mobile-menu">
                        <div className="space-y-1 px-2 pb-3 text-stone-100 underline-offset-4 font-serif">
